...
WebUI.verifyMatch(facilityName, WebUI.getText(findTestObject('Page_CURAHistory/label_facilityName', [('occurence') : occurence])), 
    false)
...
WebUI.verifyMatch(comment, WebUI.getText(findTestObject('Page_CURAHistory/label_comment', [('occurence') : occurence])), 
    false)
