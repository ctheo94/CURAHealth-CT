...
WebUI.callTestCase(findTestCase('Component/Common/Login'), [('username') : findTestData('TestData').getValue(1, 5), ('password') : findTestData(
            'TestData').getValue(2, 5)], FailureHandling.STOP_ON_FAILURE)
